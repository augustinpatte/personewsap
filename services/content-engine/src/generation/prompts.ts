...
export const CONTENT_TYPE_PROMPTS = {
  ...
  business_story: [
    ...
    "- LENGTH BUDGET (hard): body_md must be 260-330 words. The product reads at 220 words/minute and refuses anything over 120 seconds, so 330 words is the ceiling with margin. Write to the budget; do not run long and do not pad.",
  ...
  mini_case: [
    ...
    "- LENGTH BUDGET (hard): body_md must be 150-260 words. The interaction may take a few minutes, but the prose itself stays compact; over 330 words fails validation.",
