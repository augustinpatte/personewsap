...
Cette section REMPLACE le modèle binaire `is_correct` utilisé plus haut dans ce
prompt, y compris dans l'exemple JSON complet.

Partout où ce document montre :
...
```
"score_milli": 1000
"score_milli": 600 | 300 | 0
```

Le reste du Mini Case est INCHANGÉ : contexte, challenge, contraintes,
mécanisme, concept_tested, taxonomie, progression pédagogique en trois
questions, distracteurs, cooldowns. Ne rien réécrire de tout cela.

Cette section est pour le reste ADDITIVE.
