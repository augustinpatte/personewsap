  ...
  return localized(
    {
      en: {
        ...
        startFailedTitle: "Questions unavailable",
        startFailedBody:
        ...
        emptyBody: "No scored question is assigned to you for this reading.",
        questionsIntro: (count: number) =>
          count === 1 ? "One question, twenty seconds." : `${count} questions, twenty seconds each.`,
      ...
      fr: {
        ...
        startFailedTitle: "Questions indisponibles",
        startFailedBody:
        ...
        emptyBody: "Aucune question notée ne vous est attribuée pour cette lecture.",
        questionsIntro: (count: number) =>
          count === 1 ? "Une question, vingt secondes." : `${count} questions, vingt secondes chacune.`,
